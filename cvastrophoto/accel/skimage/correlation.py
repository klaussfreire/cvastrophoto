...
if with_cupy:
    ...
    def _cupy_phase_cross_correlation(
        ...
        float_dtype = image_product.dtype.type().real.dtype
        ...
        maxima = np.unravel_index(maxima.get(), cross_correlation.shape)
        ...
        # If upsampling > 1, then refine estimate with matrix multiply DFT
            ...
            dftmaxima = cp.argmax(cp.abs(cross_correlation))
            dftmaxima = np.unravel_index(dftmaxima.get(), cross_correlation.shape)
