...
pantograph.clearCanvas = function(mess) {
	var hidCtx = pantograph.hiddenContext;
	var hidCvs = pantograph.hiddenCanvas;

	reqAnimFrame(function () {
		hidCtx.clearRect(0, 0, hidCvs.width, hidCvs.height);
	});
}

pantograph.drawShape = function(shape) {
	var selectedContext = shape["ctx"]
	var ctx = (selectedContext == "fg") ? pantograph.context : pantograph.hiddenContext;
