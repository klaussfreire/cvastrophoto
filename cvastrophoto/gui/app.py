...
class Application(tk.Frame):
    ...
    def _cap_shift_exec(self, cap_shift_from, cap_shift_to, solve_hint):
        ...
        guider_from = cap_wcs.wcs.s2p(guider_wcs.wcs.p2s([cap_shift_from], 0)['world'], 0)['pixcrd'][0]
        guider_to = cap_wcs.wcs.s2p(guider_wcs.wcs.p2s([cap_shift_to], 0)['world'], 0)['pixcrd'][0]
