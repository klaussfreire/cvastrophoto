...
class WhiteBalanceRop(BaseRop):
    ...
    WB_SETS = {
        ...
        'mn34230-orion5561': (1.38087321, 1.0, 1.16966857, 1.0),
    }
    ...
    WB_MATRICES = {
        ...
        'hago': HAGO_MATRIX,
        'sho2hoo': SHO2HOO_MATRIX,
        'sho2hso': SHO2HSO_MATRIX,
        'rgb2hoo': RGB2HOO_MATRIX,
    }
